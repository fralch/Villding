...
// Tipos y interfaces
export interface ActivityItemCompleteRef {handleUpdateActivity: () => Promise<boolean>;}
 ...
 */
const ActivityItemComplete = forwardRef<ActivityItemCompleteRef, ActivityItemCompleteProps>((props, ref) => {
